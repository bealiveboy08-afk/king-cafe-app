...
export interface Order {
  ...
  generatedVerificationCode?: string; // 4-digit code generated for staff to hand to table
  customerEnteredCode?: string; // 4-digit code entered by customer on screen
